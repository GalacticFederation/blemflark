...
unlocked to sign the Blemflark-Qt.app bundle.
...
allowing somebody to distribute a Blemflark-Qt.app or blemflark-qt-setup.exe with a valid
...
that the blemflark-qt.exe file inside the installer had not been tampered with.
