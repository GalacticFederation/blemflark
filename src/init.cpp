 ...
 * between blemflarkd, and blemflark-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("blemflark-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), BLEMFLARK_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/blemflark/blemflark>";
    const std::string URL_WEBSITE = "<https://blemflarkcore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("blemflark-loadblk");
...
/** Sanity checks
 *  Ensure that Blemflark is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Blemflark process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", BLEMFLARK_CONF_FILENAME)).string());
