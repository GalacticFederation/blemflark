...
public:
    ...
    QPushButton *openBlemflarkConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        blemflarkAtStartup = new QCheckBox(tabMain);
        blemflarkAtStartup->setObjectName(QStringLiteral("blemflarkAtStartup"));

        verticalLayout_Main->addWidget(blemflarkAtStartup);
        ...
        openBlemflarkConfButton = new QPushButton(OptionsDialog);
        openBlemflarkConfButton->setObjectName(QStringLiteral("openBlemflarkConfButton"));
        openBlemflarkConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openBlemflarkConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        blemflarkAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        blemflarkAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Blemflark client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Blemflark network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Blemflark network through a separate SOCKS5 proxy for Tor hidden services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        openBlemflarkConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        openBlemflarkConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
