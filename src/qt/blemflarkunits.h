...
#ifndef BLEMFLARK_QT_BLEMFLARKUNITS_H
#define BLEMFLARK_QT_BLEMFLARKUNITS_H
...
/** Blemflark unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BlemflarkUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BlemflarkUnits(QObject *parent);

    /** Blemflark units.
      @note Source: https://en.blemflark.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BFM,
...
typedef BlemflarkUnits::Unit BlemflarkUnit;

#endif // BLEMFLARK_QT_BLEMFLARKUNITS_H
