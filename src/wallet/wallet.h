...
#ifndef BLEMFLARK_WALLET_WALLET_H
#define BLEMFLARK_WALLET_WALLET_H
...
enum WalletFeature
{
    ...
    FEATURE_HD = 30000, // Hierarchical key derivation after BIP32 (HD Wallet)

    FEATURE_HD_SPLIT = 30000, // Wallet with HD chain split (change outputs will use m/0'/1'/k)
...
public:
     ...
     * on this blemflark node, and set to 0 for transactions that were created
...
#endif // BLEMFLARK_WALLET_WALLET_H
