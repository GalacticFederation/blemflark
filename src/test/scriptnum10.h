...
#ifndef BLEMFLARK_TEST_SCRIPTNUM10_H
#define BLEMFLARK_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Blemflark Core 0.10.0, for cross-comparison.
 */
public:
