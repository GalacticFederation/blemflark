...
{
    BOOST_CHECK(TestSplitHost("www.blemflark.org", "www.blemflark.org", -1));
    BOOST_CHECK(TestSplitHost("[www.blemflark.org]", "www.blemflark.org", -1));
    BOOST_CHECK(TestSplitHost("www.blemflark.org:80", "www.blemflark.org", 80));
    BOOST_CHECK(TestSplitHost("[www.blemflark.org]:80", "www.blemflark.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:7333", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7333", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7333", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:7333", "::", 8333));
    BOOST_CHECK(TestSplitHost("::7333", "::8333", -1));
    BOOST_CHECK(TestSplitHost(":7333", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:7333", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:7333", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7333", "[::]:8333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
