...
This document provides guidelines for internationalization of the Blemflark Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `blemflark_en.ts` remains unchanged.
