...
from test_framework.test_framework import BlemflarkTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (BlemflarkTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that blemflark has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("blemflarkd has not been built with zmq enabled.")
        ...
        ip_address = "tcp://127.0.0.1:27332"
