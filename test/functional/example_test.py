...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BlemflarkTestFramework
    pass

class ExampleTest(BlemflarkTestFramework):
    # Each functional test is a subclass of the BlemflarkTestFramework class.
    ...
    def custom_method(self):
        ...
        BlemflarkTestFramework class so other tests can use it."""
