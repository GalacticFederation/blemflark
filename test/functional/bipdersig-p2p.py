...
class BIP66Test(BlemflarkTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # blemflarkd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and blemflarkd produces more specific reject
            # reasons.
